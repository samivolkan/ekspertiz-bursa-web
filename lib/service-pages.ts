...
export const serviceLandingPages: ServiceLandingPage[] = [
  ...
  },
  {
    ...
    description: "Nilüfer Küçük Sanayi ve Üçevler çevresindeki şube adresini, çalışma saatlerini, yol tarifini ve oto ekspertiz paketlerini tek sayfada inceleyin.",
    introduction: "Nilüfer sayfası yalnız bir konum adı tekrarı değildir; Küçük Sanayi ve Üçevler çevresindeki şube adresi, yol tarifi, çalışma saatleri ve randevu teyit sürecini bir araya getirir. Beşevler, Odunluk ve Ataevler tarafından gelen kullanıcılar da araç için doğru paket seçildikten sonra tarih talebi oluşturabilir.",
    checks: ["Paket kapsamına göre araç sistemleri", "Küçük Sanayi ve Üçevler konum bilgisi", "Beşevler, Odunluk ve Ataevler çevresinden ulaşım", "Telefon ve WhatsApp ile aynı gün müsaitlik sorgusu", "Çevrim içi randevu talebi"],
    helpsIdentify: ["Araç için gerekli kontrol derinliği", "Şubeye ulaşım ve iletişim kanalları", "Nilüfer içinde yakın bölge arama niyeti", "Müsaitlik teyidinden önce hazırlanması gereken bilgiler"],
